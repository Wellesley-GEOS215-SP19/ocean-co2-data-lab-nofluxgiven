...
geoshow('landareas.shp','FaceColor','black');
title('Difference between mean seawater and atmospheric pCO2')
...
title("BATS Station Temperature Effect")
xlabel("Month")
ylabel("Sea Surface Temp °C")
subplot(3,1,3)
plot(mongrid, batsbio1)
title("BATS Station Biophysical effect")
xlabel("Month")
...
plong= find(longvector==217.500)
 papapCO2= pCO2Gridlong(plong,plat,:)
 
 papasst= sstGrid(plong,plat,:)
  papabio= biopCO2(plong,plat, :)
papaCO21=squeeze(papapCO2)
...
ylabel("Seawater pCO2") 
subplot(3,1,2)
plot(mongrid, papasst1)
title("Station Papa Seasonal Temperature Effect")
xlabel("Month")
ylabel("Sea Surface Temp °C")
subplot(3,1,3)
plot(mongrid, papabio1)
title("Station Papa Biophysical Effect")
xlabel("Month")
ylabel("Seawater Biophys effect")
%% Ross Sea
...
rlong= find(longvector==187.500);
 rpCO2= pCO2Gridlong(rlat,rlong,:);
 
 rsst= sstGrid(rlong,rlat,:)
  rbio= biopCO2(rlong,rlat, :)
rpCO21=squeeze(rpCO2);
rsst1=squeeze(rsst);
rbio1=squeeze(rbio);
...
subplot(3,1,2)
plot(mongrid, rsst1)
title("Ross Sea Seasonal Temperature Effect")
xlabel("Month")
ylabel("Sea Surface Temp °C")
subplot(3,1,3)
plot(mongrid, rbio1)
title("Ross Sea Biophysical Effect")
xlabel("Month")
ylabel("Biophys pCO2 effect")
